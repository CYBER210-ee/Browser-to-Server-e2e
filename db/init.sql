...
CREATE TABLE IF NOT EXISTS history_records (
  ...
  server_name TEXT   NOT NULL,   -- which echo server filed it; history is per server (D031)
...
CREATE INDEX IF NOT EXISTS history_records_server_owner_idx ON history_records (server_name, owner, id);
